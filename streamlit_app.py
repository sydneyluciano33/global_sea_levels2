...
st.markdown("""
***TIPS:***
1. *Pick a region from the top 10 most volatile sea regions. Then, scroll down and examine how their volatility compares to the yearly average of all sea regions each year.*  
2. *Click a region on the bar chart below to highlight it on the dot plot under it. Make sure to **CLICK THE WHITE SPACE** to reset the selection.*
""")
